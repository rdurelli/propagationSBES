...
Furthermore, to perform the case study we selected four refactorings: \textit{Extract Class}, \textit{Move Class}, \textit{Extract Layer} and \textit{Remove Class}. %We applied each of the four refactorings to every possible location in KDM instance. 
