...
\section{Architecture-Driven Modernization (ADM) and Knowledge Discovery Metamodel (KDM)} % (fold)
...
%shows schematically the potential of KDM for representing four views of an Academic Management System: \texttt{Code View}, \texttt{Architecture View}, \texttt{Data View} and \texttt{Conceptual View}.
%
...
%	\centering
	% Requires \usepackage{graphicx}
%	\includegraphics[width=7.1in, height=2.7in]{figuras/TreeNewJointRafael}
...
%A simplified and schematic representation of the system shown in Figure~\ref{fig:system} can be realized in KDM as it is shown in Figure~\ref{fig:allKDMLayers}. 
%
