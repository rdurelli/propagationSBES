...
%\subsection{Model-to-Model Transformations}\label{sec:m2m}

%Models are neither isolated nor static entities. As part of an MDA process, models can be refactored (to improve their internal structure). Refactorings in the context of MDA are implemented as model transformations, i.e., Model-to-Model (M2M). 
