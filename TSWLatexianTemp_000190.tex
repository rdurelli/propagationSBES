...
\newcommand*\foobarMeu{\includegraphics{figuras/arrow}}
\newcommand*\thicherArrowMEU{\includegraphics{figuras/thicher_arrow3}}
...
\author{\IEEEauthorblockN{Rafael Serapilha Durelli\IEEEauthorrefmark{2},
Fernando Chagas\IEEEauthorrefmark{1},
Bruno M. Santos\IEEEauthorrefmark{1},\\
Marcio Eduardo Delamaro\IEEEauthorrefmark{2} and
Valter Vieira de Camargo\IEEEauthorrefmark{1}}
\IEEEauthorblockA{\IEEEauthorrefmark{1}Departamento de Computa\c{c}\~{a}o,
Universidade Federal de  S\~{a}o Carlos,\\
Caixa Postal 676 -- 13.565-905, S\~{a}o Carlos -- SP -- Brazil\\ Email: \{fernando\_chagas, bruno.santos, valter\}@dc.ufscar.br}
